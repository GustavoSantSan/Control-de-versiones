...
int main()
{
  ...
  glm::mat4 model2(1.0);
    ...
    model2 = model;    // Punto de guardado
...
// CANASTA
    ...
    model = glm::translate(model, glm::vec3(1.75f, -0.00f, 0.0f));
    ...
    meshList[0]->RenderMesh(); 
		...
		// CArro
		modelaux = model2; // Para solo seguir usando moedel aux
		...
		model = glm::scale(model, glm::vec3(7.0f, 2.0f, 3.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
...
// Si vemos el carrito desde la parte trasera
		//articulación 5 llanta del frente izq
		model = modelaux;
    ...
    model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		//articulación 6 (que usa a la articulación 5) llanta del frente derecha
		model = modelaux;
		model = glm::translate(model, glm::vec3(-3.5f, -1.0f, -1.5f));
    ...
    model = glm::scale(model, glm::vec3(2.0f, 1.5f, 2.0f));
		...
		// articulación 7 (que usa a la articulacion 6) llanta trasera izquierda
		model = modelaux;
		model = glm::translate(model, glm::vec3(3.5f, -1.0f, 1.5f));
    ...
    model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		//articulación 8 (que usa a la articulación 6) llanta trasera derecha
		model = modelaux;
		model = glm::translate(model, glm::vec3(3.5f, -1.0f, -1.5f));
